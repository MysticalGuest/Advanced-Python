...
# data.plot(x="arr_month",kind='bar')    #绘制柱形图命令
plt.bar(arr_month+0.2, arr_nan, width=0.2)

plt.bar(arr_month, arr_nv, width=0.2, alpha=0.5)
